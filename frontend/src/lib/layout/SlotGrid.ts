 ...
 *
 * This is a lib-local re-implementation — does NOT import from the app.
 */
 ...
 *
 * Layout contract:
 * - Usable column area: above the bottom strip, below the top-bar.
 * - Left column starts at x = SLOT_MARGIN.
 * - Right column starts at x = W - COLUMN_WIDTH - SLOT_MARGIN.
 * - Both columns are divided into 3 equal cells stacked vertically.
 * - Bottom strip: 3 equal-width cells spanning full viewport width.
 */
 ...
 * Returns a full Record so consumers don't need to call computeSlot 9 times.
 */
