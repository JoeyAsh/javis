    ...
    <div className="dock">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
        ...
        <button
          ...
          onTouchStart={pttEnabled ? (e) => { e.preventDefault(); handlePressStart(); } : undefined}
          onTouchEnd={pttEnabled ? (e) => { e.preventDefault(); handlePressEnd(); } : undefined}
      ...
      <div className="dock-status">
        <span className={`state${isActive ? ' on' : ''}`}>
          {LABEL_FOR_STATE[orbState]}
        </span>
