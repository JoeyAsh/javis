...
export function Window({
    ...
    }, [livePos, liveSize, rect.x, rect.y, rect.w, rect.h, state.zIndex, swapLifting]);
    ...
    const headerActions = (
        <span className="window-header-buttons" data-no-drag>
            ...
            {/* Reset position */}
            <HudIconButton aria-label="Reset window position" onClick={onResetBtn}>
                <ResetIcon />
            </HudIconButton>
            {/* Maximize / minimize */}
            <HudIconButton
    ...
    return (
        ...
        >
            ...
            <div ref={resizeRef} className="window-resize" aria-hidden data-no-drag />
        </div>
    );
}
