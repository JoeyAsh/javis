    ...
    return (
        <div style={SECTION_STYLE}>
            ...
            <input
                ...
                value={panelOpacity}
                onChange={(e) => {
                    onPanelOpacityChange(parseFloat(e.target.value));
                }}
    ...
    return (
        <div style={SECTION_STYLE}>
            ...
            >
                ...
                {saveStatus === 'saved' && (
                    <span
                        style={{ fontSize: 9, color: 'var(--success)', fontFamily: 'var(--font)' }}
                    >
                        saved
                    </span>
                )}
                {saveStatus === 'error' && (
                    <span
                        style={{ fontSize: 9, color: 'var(--danger)', fontFamily: 'var(--font)' }}
                    >
                        save failed
                    </span>
                )}
