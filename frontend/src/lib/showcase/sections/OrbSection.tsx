...
import { Orb, type OrbState } from '../../primitives/Orb/Orb';
import { Button } from '../../primitives/Button';
import { StateSimulator } from '../../primitives/StateSimulator';
import { Mono } from '../../primitives/Mono';

const ALL_STATES: OrbState[] = ['idle', 'listening', 'thinking', 'speaking', 'working'];
    ...
    return (
        <section id="orb" className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
                ...
                >
                    <Orb state={liveState} rings={rings} particles={particles} />
                </div>
            </div>
        </section>
    );
