/**
 * Dev feature mock data (moved from src/mock/devMock.ts).
 */
    ...
    ci: [
        {
            ...
            repo: 'jarvis',
            status: 'success',
            ranAt: new Date(Date.now() - 22 * 60_000).toISOString(),
            duration: '3m 18s',
        },
        {
            id: 'ci-2',
            repo: 'openclaw',
            status: 'failure',
            ranAt: new Date(Date.now() - 48 * 60_000).toISOString(),
            duration: '1m 42s',
        },
        {
            id: 'ci-3',
            repo: 'homelab',
            status: 'running',
            ranAt: new Date(Date.now() - 2 * 60_000).toISOString(),
            duration: '— —',
        },
        {
            id: 'ci-4',
