...
function WeatherWidget({ latitude, longitude }: WeatherWidgetProps): ReactElement {
    ...
    return (
        ...
        >
            <span className="hud-topbar__weather-icon" aria-hidden="true">
                {weather.icon}
            </span>
            {tempLabel}
        </span>
    ...
    return (
        <div className="hud-topbar" role="banner">
            ...
            <div className="hud-topbar__left">
                ...
                <span className="hud-topbar__sep" aria-hidden="true">
                    ◆
                </span>

                {/* Clock — prototype .infobar .t */}
                <span className="hud-topbar__clock" aria-label="Current time" aria-live="off">
                    {timeLabel}
                </span>
            ...
            <div className="hud-topbar__right">
                ...
                <HudIconButton aria-label="Reset layout" onClick={onResetLayout}>
                    <ResetIcon />
                </HudIconButton>
                ...
                <HudIconButton aria-label="Open settings" onClick={onOpenSettings}>
                    <SettingsIcon />
                </HudIconButton>
            </div>
        </div>
